    ...
    <div ref="myPage" style="height:calc(100vh - 50px);" @click="isShowNodeMenuPanel = false">
      ...
      <SeeksRelationGraph
        ...
        <div slot="node" slot-scope="{node}">
          <div style="height:64px;line-height: 64px;width:30px;cursor: pointer;" @contextmenu.prevent.stop="showNodeMenus(node, $event)">
             <img style="font-size: 30px;width: 40px; height:60px;" :src="node.data.myicon"/>
          </div>
...
import backgrounImage from "./assets/img/node_blue.png";
export default {
  name: 'Demo',
    ...
    showSeeksGraph(query) {
      var __graph_json_data = {
        ...
        nodes: [
          ...
          { id: '1', name: '节点-1', data: { myicon: backgrounImage} },
          { id: '2', name: '节点-2', data: { myicon: backgrounImage } },
          { id: '3', name: '节点-3', data: { myicon: backgrounImage } },
          { id: '4', name: '节点-4', data: { myicon: backgrounImage } },
          { id: '6', name: '节点-6', data: { myicon: backgrounImage } },
          { id: '7', name: '节点-7', data: { myicon: backgrounImage } },
